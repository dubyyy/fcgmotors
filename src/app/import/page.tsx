      ...
      <section className="section-padding-hero bg-secondary text-secondary-foreground">
        <div className="container">
          <div className="max-w-2xl mb-16">
            ...
            <h1 className="font-display text-3xl md:text-5xl font-bold tracking-tight">Vehicle Importation Service</h1>
            <p className="mt-4 text-secondary-foreground/70 leading-relaxed text-base sm:text-lg max-w-xl">
              We source, inspect, and deliver vehicles from the US, Canada, and Europe. Full transparency, competitive pricing, and end-to-end service.
            </p>
            <a
              href={WHATSAPP_URL}
              target="_blank"
