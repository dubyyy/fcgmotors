      ...
      <section className="section-padding bg-background">
        <div className="container">
          <div className="mb-12">
            ...
            <h1 className="font-display text-3xl md:text-5xl font-bold tracking-tight text-foreground">Contact Us</h1>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <motion.div variants={fadeUp}>
                <button type="submit" className="gold-action w-full py-3 rounded-btn text-sm font-semibold">
                  Send via WhatsApp
                </button>
              </motion.div>
            </motion.form>
