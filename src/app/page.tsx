...
const vehicles = [
  { image: camryImg, brand: "Toyota", model: "Camry", year: "2018", price: "₦14,500,000" },
  { image: lexusImg, brand: "Lexus", model: "RX 350", year: "2017", price: "₦24,000,000" },
  { image: mercedesImg, brand: "Mercedes", model: "C300", year: "2016", price: "₦19,000,000" },
];
      ...
      <section className="section-padding relative bg-background overflow-hidden preserve-3d">
        ...
        <div className="container relative z-10">
          ...
          <motion.div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10">
            {vehicles.map((v, i) => (
              <motion.div key={v.model} initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-50px" }} transition={{ delay: i * 0.15, duration: 0.8, ease: EASE }}>
                <VehicleCard {...v} />
              </motion.div>
            ))}
          </motion.div>
