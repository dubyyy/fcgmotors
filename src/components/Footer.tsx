    ...
    <footer className="bg-secondary text-secondary-foreground">
      <div className="container section-padding">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="max-w-xs">
            <h3 className="font-display mb-6">
              <div className="flex items-center">
                ...
                <span className="italic font-light tracking-[0.15em] text-2xl text-white">AUTOS</span>
              </div>
              <div className="text-[10px] uppercase tracking-[0.5em] mt-2 opacity-80 font-sans font-bold text-white">Nigeria's Finest</div>
            </h3>
            <p className="text-sm text-secondary-foreground/90 leading-relaxed font-medium">
          ...
          <div>
            <h4 className="spec-label mb-4 text-secondary-foreground/80">Quick Links</h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={l.href}>
                  <Link href={l.href} className="text-sm text-secondary-foreground/90 hover:text-primary transition-colors duration-200">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h4 className="spec-label mb-4 text-secondary-foreground/80">Contact</h4>
          ...
          <div>
            <h4 className="spec-label mb-4 text-secondary-foreground/80">Business Hours</h4>
        ...
        <div className="mt-16 pt-8 border-t border-secondary-foreground/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-secondary-foreground/70">© 2026 FGC Autos. All rights reserved.</p>
          <p className="text-xs text-secondary-foreground/70">The Standard of Nigerian Motion.</p>
        </div>
      </div>
    </footer>
  );
